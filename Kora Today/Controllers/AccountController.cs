...
namespace Kora_Today.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AssignRoleToUser()
        {
            ...
            ViewBag.Role = new SelectList(db.webpages_Roles, "RoleName", "RoleName");
            return View();
        }

        [Authorize(Roles = "Admin")]
        [HttpPost]
        public ActionResult AssignRoleToUser(string UserName , string RoleName)
        {
